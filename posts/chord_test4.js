...
///this gives just the arcs corresponding to each group + labels
...
.attr("d", path);
///this gives just the arcs corresponding to each group + labels+ chords, but no mouse over tip tool
